...
# with npm
npm i react-typeme-effect

# with yarn
yarn add react-typeme-effect
...
| ----------------- | ------------------ | ----------------------- | ------------------------------------------------------------------ |
| words             | String or String[] | "" (empty string)       | That text that will be typed and erased. Can be either an array of strings or just a string.                       |
